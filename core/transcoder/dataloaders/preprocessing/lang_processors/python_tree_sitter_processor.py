...
from core.transcoder.dataloaders.preprocessing.lang_processors.obfuscation.bobskater_obfuscator import (obfuscateString,)
...
class PythonTreeSitterProcessor(tsp.TreeSitterLangProcessor):
    ...
    def obfuscate_types(self, code: str) -> tp.Tuple[str, str]:
        ...
        return obf_code, dico_to_string(dico)
