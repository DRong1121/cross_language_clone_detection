...
sys.path.append('.')
sys.path.append('../../../../')
from core.transcoder.dataloaders.preprocessing.lang_processors.obfuscation import javalang_obfuscator
from core.transcoder.dataloaders.preprocessing.lang_processors.obfuscation.utils_deobfuscation import dico_to_string
...
RUN_ROOT_DIR = Path(__file__).parents[3] / "data/code_evaluation"
